...
<head runat="server">
    ...
    <style type="text/css">
    body {
        background-image: url('img/baground2.jpg'); 
...
<body>
    ...
    <div id="header">
        ...
        <asp:Image ID="Image3" runat="server" ImageUrl="~engine1/img/logo2.jpg" ImageAlign="AbsMiddle" Height="128px"/>
...
<a href="#"><img src="data1/images/5.jpg" alt="" title="" id="wows1"/></a>
...
<a href="#wows1" title=""><img src="data1/tooltips/5.gif" alt=""/>2</a>
...
<a style="display:none" href="http://wowslider.com">Script Image Slider by WOWSlider.com v1.7</a>
	...
	<script type="text/javascript" src="engine1/script.js"></script>
         <table class="style3">
             <tr>
                 <td class="style5">
                     <asp:Image ID="Image4" runat="server" ImageUrl="~engine1/img/mm1.png" Height="190px" Width="680px" />
                 </td>
             </tr>
         </table>
         </div>
     </div> <div id="footer"> Student Attandance System By Somesh More</div>
    </form>
</body>
</html>
